...
{ "Unknown", "recipe_make_dockmodule",
	...
	"recipe_IPA", "recipe_refined_gold", 0 };

const wchar_t* FACTORY_NAMES[] =
{ L"Unknown", L"Unknown", L"Unknown", L"Unknown", L"Unknown",
	L"Docking Module Factory", L"Jumpdrive Factory",
	L"Hyperspace Scanner Factory", L"Cloaking Device Factory", L"Unknown", L"Unknown", L"Cloak Disruptor Factory", L"Brewery Factory", 0 };
