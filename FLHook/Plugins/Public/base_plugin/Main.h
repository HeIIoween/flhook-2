...
//struct REFRECIPE
//{
//	REFRECIPE() : produced_item(0), cooking_rate(0) {}
//	uint nickname;
//	uint produced_item;
//	wstring infotext;
//	uint cooking_rate;
...
public:
	...
	static const int TYPE_M_BREWERY = 12;
	static const int TYPE_O_REFINERY = 13;
	static const int TYPE_LAST = TYPE_O_REFINERY;
...
extern const char* MODULE_TYPE_NICKNAMES[15];
